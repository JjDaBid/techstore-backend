...
import com.techstore.repository.ProductRepo;
...
public class AdminUsers {
    ...
    public ResponseEntity<Object> signUp(@RequestBody Product product){
        ...
        productToSave.setImageFileName(product.getImageFileName());
        productToSave.setInStock(product.getInStock());
